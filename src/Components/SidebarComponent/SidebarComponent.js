...
export default class SidebarComponent extends Component {
  ...
  {
    super()
    this.state = {username: '', userFollowers: 0, userID: 0, ProfilePicture: 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.pinimg.com%2F736x%2F8b%2F16%2F7a%2F8b167af653c2399dd93b952a48740620.jpg&f=1&nofb=1&ipt=33608bf0973b950d8a9032fd47b796c156c60bf3f6edf4b174dc2947f2d9b4da&ipo=images'}
  }
  async logOut(){
  ...
  async componentDidMount()
  {
    ...
    this.setState({'username': targetUserData.Username, 'userFollowers': targetUserData.Followers, 'userID': targetUserData.id, 'ProfilePicture': targetUserData.ProfilePicture})
  }
  render() {
    return (
